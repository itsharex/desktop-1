...
const PlanIssueColumn = observer((props: KanbanPanelProps) => {
    ...
    return (
        <div className={s.kanban_column} ref={drop}>
            <Card title={`规划中(${issueList?.length ?? 0})`} style={{ border: "2px solid #e4e4e8", borderBottom: "none", minWidth: (issueList?.length == 0) ? undefined : "300px" }}
...
const ProcessIssueColumn = observer((props: ProcessPanelProps) => {
    ...
    return (
        <div className={s.kanban_column} ref={drop}>
            <Card title={`${getPanelName()}(${issueList?.length ?? 0})`} style={{ border: "2px solid #e4e4e8", borderBottom: "none", minWidth: (issueList?.length == 0) ? undefined : "300px" }}
...
const CheckIssueColumn = observer((props: KanbanPanelProps) => {
    ...
    return (
        <div className={s.kanban_column} ref={drop}>
            <Card title={`检查中(${issueList?.length ?? 0})`} style={{ border: "2px solid #e4e4e8", borderBottom: "none", minWidth: (issueList?.length == 0) ? undefined : "300px" }}
...
const CloseIssueColumn = observer((props: KanbanPanelProps) => {
    ...
    return (
        <div className={s.kanban_column} ref={drop}>
            <Card title={`完成(${issueList?.length ?? 0})`} style={{ border: "2px solid #e4e4e8", borderBottom: "none", minWidth: (issueList?.length == 0) ? undefined : "300px" }}
