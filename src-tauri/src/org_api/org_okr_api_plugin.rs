...
use proto_gen_rust::org_okr_api::org_okr_api_client::OrgOkrApiClient;
use proto_gen_rust::org_okr_api::*;
use tauri::{
...
async fn create<R: Runtime>(
    ...
    let mut client = OrgOkrApiClient::new(chan.unwrap());
...
pub struct OrgOkrApiPlugin<R: Runtime> {
    invoke_handler: Box<dyn Fn(Invoke<R>) + Send + Sync + 'static>,
}

impl<R: Runtime> OrgOkrApiPlugin<R> {
    pub fn new() -> Self {
        Self {
...
impl<R: Runtime> Plugin<R> for OrgOkrApiPlugin<R> {
